...
<div class="hero-section hero-background style-02">
    ...
    <nav class="biolife-nav">
        <ul>
            ...
            <li class="nav-item"><a href="{{ route('berita') }}" class="permal-link">Berita</a></li>
            <li class="nav-item"><span class="current-page">{{ $berita['judul'] }}</span></li>
        </ul>
    </nav>
</div>
@endsection
        ...
        <div class="row">
            ...
            <div id="main-content" class="main-content col-lg-9 col-md-8 col-sm-12 col-xs-12">
                ...
                <div class="single-post-contain">
                    ...
                    <div class="post-head">
                        <div class="thumbnail">
                            <figure><img src="{{ $berita['image'] }}" width="870" height="635" alt=""></figure>
                        </div>
                        <h2 class="post-name">{{ $berita['judul'] }}</h2>
                    </div>
